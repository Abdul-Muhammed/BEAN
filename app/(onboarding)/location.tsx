...
export default function LocationScreen() {
  ...
  // Generate Mapbox GL JS HTML (works in Expo Go via WebView)
  const getMapHtml = () => {
    const { latitude, longitude } = mapLocation;
    const mapboxToken = process.env.EXPO_PUBLIC_MAPBOX_ACCESS_TOKEN || '';
    
    // Using Mapbox GL JS - sleek Mapbox aesthetics, works in WebView
    return `
      <!DOCTYPE html>
      <html>
        <head>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.form}>
          ...
          {/* Map View using WebView with Mapbox GL JS (works in Expo Go) */}
          ...
          <TouchableOpacity
            style={[
              styles.nextButton,
              !address.trim() && styles.nextButtonDisabled
            ]}
            onPress={handleNext}
          ...
          >
            <Text style={[
              ...
              !address.trim() && styles.nextButtonTextDisabled
            ]}>
              Next
            </Text>
          </TouchableOpacity>
